...
public class CarDataRestController {
    ...
    public ResponseEntity saveADL(@RequestBody CarData newCar) {
        ...
        try {
            //CarData oldCar = repository.findTopByVinOrderByTimeStampDesc(newCar.getVin());        //Cause problems. Implement it later!
    ...
    public ResponseEntity tellIngressEverythingIsAlive() {
        log.debug("Called \"/\". Maybe lifenes or readynes probe");
